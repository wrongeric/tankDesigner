class EricTank extends BaseTank{
    ...
    fireAndRescan(){
        ...
        if(gunSpecs.range > this.currentTarget.range){
            this.fireCannon();
            setTimeout(this.reScan.bind(this), 200);
        } else {
            this.currentMode = 'hunt';
            this.on('bodyTurnComplete',this.moveForwardAndScan.bind(this,500));
    ...
    moveForwardAndScan(duration=10000){
        this.move('forward');
